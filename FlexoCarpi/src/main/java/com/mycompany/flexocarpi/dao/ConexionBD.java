 ...
 */
 ...
 public class ConexionBD {
    ...
    private static final String URL_DB = "jdbc:mariadb://localhost:3306/flexocarpi";  // URL de la base de datos
    private static final String USER_DB = "root";  // Usuario de la base de datos
    private static final String PASSWORD_DB = "0405";  // Contraseña de la base de datos
